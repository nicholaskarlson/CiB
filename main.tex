...
\section*{Conclusion}
\paragraph{}
This chapter introduces the important idea of a limit. Please fork the LaTeX source code for CiB (available on GitHub) and create your own book that chooses the facts and exercises most relevant to you! Also, starring the CiB project on GitHub would be greatly appreciated! Thanks for reading CiB!
