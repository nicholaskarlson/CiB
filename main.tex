...
\begin{titlepage}
    \begin{tikzpicture}[remember picture, overlay]
        ...
        \node at (current page.center) [font=\Huge, text width=0.8\textwidth, align=center] 
            {\textbf{Calculus in Brief with GitHub and \LaTeX  \\ CiB - Version 0.1}};
...
\chapter{Foundational Topics in Calculus}
\subsection*{Introduction}
In this chapter, we start talking about fundamental calculus topics. Here we will introduce functions, limits, and the derivative.
...
\paragraph{}
Functions are important in the study of calculus.

\section*{Conclusion}
\paragraph{}
This chapter introduces the important idea of a function. Please fork the LaTeX source code for CiB (available on GitHub) and create your own book that chooses the facts and exercises most relevant to you! Also, starring the CiB project on GitHub would be greatly appreciated! Thanks for reading CiB!

\chapter{Limits}
\subsection*{Basic Concepts Regarding Limits}
...
\section*{Conclusion}
\paragraph{}
This chapter introduces the important idea of a limit. The idea of a limit is used in the definition of a derivative. Please fork the LaTeX source code for CiB (available on GitHub) and create your own book that chooses the facts and exercises most relevant to you! Also, starring the CiB project on GitHub would be greatly appreciated! Thanks for reading CiB!

\chapter{The Derivative}
\subsection*{Understanding Derivative Basics}

\section*{Introduction}
\paragraph{}
The concept of a derivative is fundamental in the study of calculus.

\section*{Conclusion}
\paragraph{}
This chapter introduces the important topic of the derivative. Please fork the LaTeX source code for CiB (available on GitHub) and create your own book that chooses the facts and exercises most relevant to you! Also, starring the CiB project on GitHub would be greatly appreciated! Thanks for reading CiB!
